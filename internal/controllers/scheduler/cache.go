...
type CacheStrategy interface {
	Key(instance *v1alpha1.Instance) (types.UID, error)
	ContainerKey(instance *v1alpha1.Instance) string
}
...
func (defaultCacheStrategy) Key(instance *v1alpha1.Instance) (types.UID, error) {
	uid := instance.GetUID()
	if uid == "" {
...
func (defaultCacheStrategy) ContainerKey(instance *v1alpha1.Instance) string {
...
func (c *Cache) updateInstance(log logr.Logger, key types.UID, oldInstance, newInstance *v1alpha1.Instance) {
	c.removeInstance(log, key, oldInstance)
	c.addInstance(log, key, newInstance, false)
}

func (c *Cache) addInstance(_ logr.Logger, key types.UID, instance *v1alpha1.Instance, assume bool) {
...
func (c *Cache) removeInstance(log logr.Logger, key types.UID, instance *v1alpha1.Instance) {
	containerKey := c.strategy.ContainerKey(instance)
	n, ok := c.nodes[containerKey]
	if !ok {
