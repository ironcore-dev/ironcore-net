...
import (
	...
	utilclient "github.com/onmetal/onmetal-api-net/utils/client"
)

var (
	SourceAwareSystem = utilclient.NewSourceAwareSystem(utilapi.PrefixSourceAwareSystem("metalnetlet.api.onmetal.de/"))
