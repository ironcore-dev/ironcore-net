...
func main() {
	...
	var disablePeeringStatusPropagation bool
	...
	flag.BoolVar(&disablePeeringStatusPropagation, "disable-peering-status-propagation", false,
	...
	if err = (&controllers.NetworkReconciler{
		...
		APINetNamespace:                  apiNetNamespace,
		WatchFilterValue:                 watchFilterValue,
		PeeringStatusPropagationDisabled: disablePeeringStatusPropagation,
	}).SetupWithManager(mgr, apiNetCluster.GetCache()); err != nil {
