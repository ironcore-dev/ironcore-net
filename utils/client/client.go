...
// UIDExistsSelector selects all items where the UID label key of the origin exists. The actual value
// is not checked. If the origin is namespaced, the namespace label is compared with the desired namespace value.
