...
func (in *AllocatorRef) DeepCopyInto(out *AllocatorRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AllocatorRef.
func (in *AllocatorRef) DeepCopy() *AllocatorRef {
	if in == nil {
		return nil
	}
	out := new(AllocatorRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PublicIPSpec) DeepCopyInto(out *PublicIPSpec) {
	*out = *in
	...
	out.AllocatorRef = in.AllocatorRef
}
