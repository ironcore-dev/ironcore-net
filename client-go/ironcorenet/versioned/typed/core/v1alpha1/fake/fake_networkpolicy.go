...
type fakeNetworkPolicies struct {
	*gentype.FakeClientWithListAndApply[*v1alpha1.NetworkPolicy, *v1alpha1.NetworkPolicyList, *corev1alpha1.NetworkPolicyApplyConfiguration]
	Fake *FakeCoreV1alpha1
}

func newFakeNetworkPolicies(fake *FakeCoreV1alpha1, namespace string) typedcorev1alpha1.NetworkPolicyInterface {
	return &fakeNetworkPolicies{
		gentype.NewFakeClientWithListAndApply[*v1alpha1.NetworkPolicy, *v1alpha1.NetworkPolicyList, *corev1alpha1.NetworkPolicyApplyConfiguration](
			fake.Fake,
			namespace,
