...
func (c *FakeNetworkInterfaces) Apply(ctx context.Context, networkInterface *corev1alpha1.NetworkInterfaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NetworkInterface, err error) {
...
func (c *FakeNetworkInterfaces) ApplyStatus(ctx context.Context, networkInterface *corev1alpha1.NetworkInterfaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NetworkInterface, err error) {
	if networkInterface == nil {
		return nil, fmt.Errorf("networkInterface provided to Apply must not be nil")
	}
	data, err := json.Marshal(networkInterface)
