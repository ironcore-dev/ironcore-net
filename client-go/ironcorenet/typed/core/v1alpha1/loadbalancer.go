...
type LoadBalancerInterface interface {
	...
	Apply(ctx context.Context, loadBalancer *corev1alpha1.LoadBalancerApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.LoadBalancer, err error)
	ApplyStatus(ctx context.Context, loadBalancer *corev1alpha1.LoadBalancerApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.LoadBalancer, err error)
...
func (c *loadBalancers) Apply(ctx context.Context, loadBalancer *corev1alpha1.LoadBalancerApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.LoadBalancer, err error) {
	if loadBalancer == nil {
...
func (c *loadBalancers) ApplyStatus(ctx context.Context, loadBalancer *corev1alpha1.LoadBalancerApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.LoadBalancer, err error) {
	if loadBalancer == nil {
		return nil, fmt.Errorf("loadBalancer provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
