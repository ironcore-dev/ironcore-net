...
func (c *iPAddresses) Apply(ctx context.Context, iPAddress *corev1alpha1.IPAddressApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IPAddress, err error) {
	if iPAddress == nil {
