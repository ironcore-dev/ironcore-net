...
func (c *iPs) Apply(ctx context.Context, iP *corev1alpha1.IPApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IP, err error) {
	if iP == nil {
...
func (c *iPs) ApplyStatus(ctx context.Context, iP *corev1alpha1.IPApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IP, err error) {
	if iP == nil {
		return nil, fmt.Errorf("iP provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
