...
func (b *NetworkPolicyRuleApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *NetworkPolicyRuleApplyConfiguration) GetAPIVersion() *string {
...
func (b *NetworkPolicyRuleApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
