...
func extractNetworkID(networkID *corev1alpha1.NetworkID, fieldManager string, subresource string) (*NetworkIDApplyConfiguration, error) {
	b := &NetworkIDApplyConfiguration{}
	err := managedfields.ExtractInto(networkID, internal.Parser().Type("com.github.onmetal.onmetal-api-net.api.core.v1alpha1.NetworkID"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
