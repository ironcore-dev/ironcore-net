...
func ExtractNATGatewayFrom(nATGateway *corev1alpha1.NATGateway, fieldManager string, subresource string) (*NATGatewayApplyConfiguration, error) {
	b := &NATGatewayApplyConfiguration{}
	err := managedfields.ExtractInto(nATGateway, internal.Parser().Type("com.github.ironcore-dev.ironcore-net.api.core.v1alpha1.NATGateway"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
