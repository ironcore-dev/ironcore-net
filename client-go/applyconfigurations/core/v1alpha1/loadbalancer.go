...
func ExtractLoadBalancerFrom(loadBalancer *corev1alpha1.LoadBalancer, fieldManager string, subresource string) (*LoadBalancerApplyConfiguration, error) {
	b := &LoadBalancerApplyConfiguration{}
	err := managedfields.ExtractInto(loadBalancer, internal.Parser().Type("com.github.ironcore-dev.ironcore-net.api.core.v1alpha1.LoadBalancer"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
