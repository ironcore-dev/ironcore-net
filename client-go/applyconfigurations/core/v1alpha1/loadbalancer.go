...
func extractLoadBalancer(loadBalancer *corev1alpha1.LoadBalancer, fieldManager string, subresource string) (*LoadBalancerApplyConfiguration, error) {
	b := &LoadBalancerApplyConfiguration{}
	err := managedfields.ExtractInto(loadBalancer, internal.Parser().Type("com.github.onmetal.onmetal-api-net.api.core.v1alpha1.LoadBalancer"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
