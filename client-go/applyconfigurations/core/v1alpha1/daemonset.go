...
func extractDaemonSet(daemonSet *corev1alpha1.DaemonSet, fieldManager string, subresource string) (*DaemonSetApplyConfiguration, error) {
	b := &DaemonSetApplyConfiguration{}
	err := managedfields.ExtractInto(daemonSet, internal.Parser().Type("com.github.onmetal.onmetal-api-net.api.core.v1alpha1.DaemonSet"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
