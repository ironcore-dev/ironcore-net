...
func (b *NATGatewayAutoscalerApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *NATGatewayAutoscalerApplyConfiguration) GetAPIVersion() *string {
...
func (b *NATGatewayAutoscalerApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
