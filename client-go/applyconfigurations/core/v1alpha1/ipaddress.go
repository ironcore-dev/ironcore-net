...
func extractIPAddress(iPAddress *corev1alpha1.IPAddress, fieldManager string, subresource string) (*IPAddressApplyConfiguration, error) {
	b := &IPAddressApplyConfiguration{}
	err := managedfields.ExtractInto(iPAddress, internal.Parser().Type("com.github.onmetal.onmetal-api-net.api.core.v1alpha1.IPAddress"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
