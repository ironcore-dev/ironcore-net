...
func extractNATTable(nATTable *corev1alpha1.NATTable, fieldManager string, subresource string) (*NATTableApplyConfiguration, error) {
	...
	b.WithName(nATTable.Name)
	b.WithNamespace(nATTable.Namespace)
...
func (b *NATTableApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *NATTableApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *NATTableApplyConfiguration) GetAPIVersion() *string {
...
func (b *NATTableApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
