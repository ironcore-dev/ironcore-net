...
func ExtractNetworkFrom(network *corev1alpha1.Network, fieldManager string, subresource string) (*NetworkApplyConfiguration, error) {
	b := &NetworkApplyConfiguration{}
	err := managedfields.ExtractInto(network, internal.Parser().Type("com.github.ironcore-dev.ironcore-net.api.core.v1alpha1.Network"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
