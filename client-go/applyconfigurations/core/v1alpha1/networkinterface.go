...
func extractNetworkInterface(networkInterface *corev1alpha1.NetworkInterface, fieldManager string, subresource string) (*NetworkInterfaceApplyConfiguration, error) {
	b := &NetworkInterfaceApplyConfiguration{}
	err := managedfields.ExtractInto(networkInterface, internal.Parser().Type("com.github.onmetal.onmetal-api-net.api.core.v1alpha1.NetworkInterface"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
