...
func ExtractNetworkInterfaceFrom(networkInterface *corev1alpha1.NetworkInterface, fieldManager string, subresource string) (*NetworkInterfaceApplyConfiguration, error) {
	b := &NetworkInterfaceApplyConfiguration{}
	err := managedfields.ExtractInto(networkInterface, internal.Parser().Type("com.github.ironcore-dev.ironcore-net.api.core.v1alpha1.NetworkInterface"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
