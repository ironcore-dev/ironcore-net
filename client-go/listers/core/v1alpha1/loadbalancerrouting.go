...
type LoadBalancerRoutingLister interface {
	...
	List(selector labels.Selector) (ret []*corev1alpha1.LoadBalancerRouting, err error)
...
type loadBalancerRoutingLister struct {
	listers.ResourceIndexer[*corev1alpha1.LoadBalancerRouting]
}
...
func NewLoadBalancerRoutingLister(indexer cache.Indexer) LoadBalancerRoutingLister {
	return &loadBalancerRoutingLister{listers.New[*corev1alpha1.LoadBalancerRouting](indexer, corev1alpha1.Resource("loadbalancerrouting"))}
}

// LoadBalancerRoutings returns an object that can list and get LoadBalancerRoutings.
func (s *loadBalancerRoutingLister) LoadBalancerRoutings(namespace string) LoadBalancerRoutingNamespaceLister {
	return loadBalancerRoutingNamespaceLister{listers.NewNamespaced[*corev1alpha1.LoadBalancerRouting](s.ResourceIndexer, namespace)}
}
...
type LoadBalancerRoutingNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*corev1alpha1.LoadBalancerRouting, error)
