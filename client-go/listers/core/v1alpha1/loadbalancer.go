...
type LoadBalancerLister interface {
	...
	List(selector labels.Selector) (ret []*corev1alpha1.LoadBalancer, err error)
...
type loadBalancerLister struct {
	listers.ResourceIndexer[*corev1alpha1.LoadBalancer]
}
...
func (s *loadBalancerLister) LoadBalancers(namespace string) LoadBalancerNamespaceLister {
	return loadBalancerNamespaceLister{listers.NewNamespaced[*corev1alpha1.LoadBalancer](s.ResourceIndexer, namespace)}
}
