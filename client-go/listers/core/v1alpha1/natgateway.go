...
type NATGatewayLister interface {
	...
	List(selector labels.Selector) (ret []*corev1alpha1.NATGateway, err error)
...
type nATGatewayLister struct {
	listers.ResourceIndexer[*corev1alpha1.NATGateway]
}

// NewNATGatewayLister returns a new NATGatewayLister.
func NewNATGatewayLister(indexer cache.Indexer) NATGatewayLister {
	return &nATGatewayLister{listers.New[*corev1alpha1.NATGateway](indexer, corev1alpha1.Resource("natgateway"))}
}

// NATGateways returns an object that can list and get NATGateways.
func (s *nATGatewayLister) NATGateways(namespace string) NATGatewayNamespaceLister {
	return nATGatewayNamespaceLister{listers.NewNamespaced[*corev1alpha1.NATGateway](s.ResourceIndexer, namespace)}
}
...
type NATGatewayNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*corev1alpha1.NATGateway, error)
