...
type NodeIndexInformer cache.TypedSharedIndexInformer[*apicorev1alpha1.Node]

// NodeHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for Node.
type NodeHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apicorev1alpha1.Node]

// NodeDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for Node.
type NodeDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apicorev1alpha1.Node]

// NodeFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for Node.
type NodeFilteringHandler = cache.TypedFilteringResourceEventHandler[*apicorev1alpha1.Node]

// NodeIndexers is a specialization of [cache.TypedIndexers] for Node.
type NodeIndexers = cache.TypedIndexers[*apicorev1alpha1.Node]

// DeletedNode is a specialization of [cache.DeletedObject] for Node.
type DeletedNode = cache.DeletedObject[*apicorev1alpha1.Node]
...
func NewTypedNodeInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) NodeIndexInformer {
	gvr := schema.GroupVersionResource{Group: "core.apinet.ironcore.dev", Version: "v1alpha1", Resource: "nodes"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.Node](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().Nodes().List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().Nodes().Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().Nodes().List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().Nodes().Watch(ctx, opts)
			},
		}, client),
...
func (f *nodeInformer) TypedInformer() NodeIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.Node](f.factory.InformerFor(&apicorev1alpha1.Node{}, f.defaultInformer))
}
...
func (a *nodeTypedInformerAdapter) TypedInformer() NodeIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.Node](a.Informer())
}
...
func ToNodeIndexInformer(informer cache.SharedIndexInformer) NodeIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.Node](informer)
}
