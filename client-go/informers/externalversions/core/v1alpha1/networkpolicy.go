...
type NetworkPolicyIndexInformer cache.TypedSharedIndexInformer[*apicorev1alpha1.NetworkPolicy]

// NetworkPolicyHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for NetworkPolicy.
type NetworkPolicyHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apicorev1alpha1.NetworkPolicy]

// NetworkPolicyDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for NetworkPolicy.
type NetworkPolicyDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apicorev1alpha1.NetworkPolicy]

// NetworkPolicyFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for NetworkPolicy.
type NetworkPolicyFilteringHandler = cache.TypedFilteringResourceEventHandler[*apicorev1alpha1.NetworkPolicy]

// NetworkPolicyIndexers is a specialization of [cache.TypedIndexers] for NetworkPolicy.
type NetworkPolicyIndexers = cache.TypedIndexers[*apicorev1alpha1.NetworkPolicy]

// DeletedNetworkPolicy is a specialization of [cache.DeletedObject] for NetworkPolicy.
type DeletedNetworkPolicy = cache.DeletedObject[*apicorev1alpha1.NetworkPolicy]
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewTypedNetworkPolicyInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers NetworkPolicyIndexers) NetworkPolicyIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewTypedFilteredNetworkPolicyInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers NetworkPolicyIndexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) NetworkPolicyIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewTypedNetworkPolicyInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) NetworkPolicyIndexInformer {
	gvr := schema.GroupVersionResource{Group: "core.apinet.ironcore.dev", Version: "v1alpha1", Resource: "networkpolicys"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.NetworkPolicy](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().NetworkPolicies(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().NetworkPolicies(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().NetworkPolicies(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().NetworkPolicies(namespace).Watch(ctx, opts)
			},
		}, client),
		&apicorev1alpha1.NetworkPolicy{},
...
func (f *networkPolicyInformer) TypedInformer() NetworkPolicyIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.NetworkPolicy](f.factory.InformerFor(&apicorev1alpha1.NetworkPolicy{}, f.defaultInformer))
}

func (f *networkPolicyInformer) Lister() corev1alpha1.NetworkPolicyLister {
	return corev1alpha1.NewNetworkPolicyLister(f.Informer().GetIndexer())
}
...
func (a *networkPolicyTypedInformerAdapter) TypedInformer() NetworkPolicyIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.NetworkPolicy](a.Informer())
}
...
func ToNetworkPolicyIndexInformer(informer cache.SharedIndexInformer) NetworkPolicyIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.NetworkPolicy](informer)
}
