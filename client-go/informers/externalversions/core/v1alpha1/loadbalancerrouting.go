...
type LoadBalancerRoutingIndexInformer cache.TypedSharedIndexInformer[*apicorev1alpha1.LoadBalancerRouting]

// LoadBalancerRoutingHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for LoadBalancerRouting.
type LoadBalancerRoutingHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apicorev1alpha1.LoadBalancerRouting]
...
type LoadBalancerRoutingDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apicorev1alpha1.LoadBalancerRouting]
...
type LoadBalancerRoutingFilteringHandler = cache.TypedFilteringResourceEventHandler[*apicorev1alpha1.LoadBalancerRouting]

// LoadBalancerRoutingIndexers is a specialization of [cache.TypedIndexers] for LoadBalancerRouting.
type LoadBalancerRoutingIndexers = cache.TypedIndexers[*apicorev1alpha1.LoadBalancerRouting]

// DeletedLoadBalancerRouting is a specialization of [cache.DeletedObject] for LoadBalancerRouting.
type DeletedLoadBalancerRouting = cache.DeletedObject[*apicorev1alpha1.LoadBalancerRouting]
...
func NewTypedLoadBalancerRoutingInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) LoadBalancerRoutingIndexInformer {
	gvr := schema.GroupVersionResource{Group: "core.apinet.ironcore.dev", Version: "v1alpha1", Resource: "loadbalancerroutings"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.LoadBalancerRouting](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().LoadBalancerRoutings(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().LoadBalancerRoutings(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().LoadBalancerRoutings(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().LoadBalancerRoutings(namespace).Watch(ctx, opts)
			},
		}, client),
...
func (f *loadBalancerRoutingInformer) TypedInformer() LoadBalancerRoutingIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.LoadBalancerRouting](f.factory.InformerFor(&apicorev1alpha1.LoadBalancerRouting{}, f.defaultInformer))
}
...
func (a *loadBalancerRoutingTypedInformerAdapter) TypedInformer() LoadBalancerRoutingIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.LoadBalancerRouting](a.Informer())
}
...
func ToLoadBalancerRoutingIndexInformer(informer cache.SharedIndexInformer) LoadBalancerRoutingIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.LoadBalancerRouting](informer)
}
