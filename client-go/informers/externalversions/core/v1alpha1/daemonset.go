...
type DaemonSetIndexInformer cache.TypedSharedIndexInformer[*apicorev1alpha1.DaemonSet]

// DaemonSetHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for DaemonSet.
type DaemonSetHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apicorev1alpha1.DaemonSet]

// DaemonSetDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for DaemonSet.
type DaemonSetDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apicorev1alpha1.DaemonSet]

// DaemonSetFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for DaemonSet.
type DaemonSetFilteringHandler = cache.TypedFilteringResourceEventHandler[*apicorev1alpha1.DaemonSet]

// DaemonSetIndexers is a specialization of [cache.TypedIndexers] for DaemonSet.
type DaemonSetIndexers = cache.TypedIndexers[*apicorev1alpha1.DaemonSet]

// DeletedDaemonSet is a specialization of [cache.DeletedObject] for DaemonSet.
type DeletedDaemonSet = cache.DeletedObject[*apicorev1alpha1.DaemonSet]
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewTypedDaemonSetInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers DaemonSetIndexers) DaemonSetIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewTypedFilteredDaemonSetInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers DaemonSetIndexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) DaemonSetIndexInformer {
...
func NewDaemonSetInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewTypedDaemonSetInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) DaemonSetIndexInformer {
	gvr := schema.GroupVersionResource{Group: "core.apinet.ironcore.dev", Version: "v1alpha1", Resource: "daemonsets"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.DaemonSet](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().DaemonSets(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().DaemonSets(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().DaemonSets(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.CoreV1alpha1().DaemonSets(namespace).Watch(ctx, opts)
			},
		}, client),
...
func (f *daemonSetInformer) TypedInformer() DaemonSetIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.DaemonSet](f.factory.InformerFor(&apicorev1alpha1.DaemonSet{}, f.defaultInformer))
}
...
func (a *daemonSetTypedInformerAdapter) TypedInformer() DaemonSetIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.DaemonSet](a.Informer())
}
...
func ToDaemonSetIndexInformer(informer cache.SharedIndexInformer) DaemonSetIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apicorev1alpha1.DaemonSet](informer)
}
